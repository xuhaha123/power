                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="demo-main-tab1" class="tab-pane">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control" name="name" placeholder="请输入用户名" value="{{$res->name}}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">邮箱</label>
                                            <div class="col-lg-9">
                                                <input type="email" class="form-control" name="email" placeholder="Email" value="{{$res->email}}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">手机号</label>
                                            <div class="col-lg-9">
                                                <input type="email" class="form-control" name="phone" placeholder="请输入手机号" value="{{$res->phone}}">
                                            </div>
                                        </div>
                                    </div>
